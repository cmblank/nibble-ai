...
class PantryItem {
  ...
  // Handle numeric values that might arrive as int or double
  ...
  @override
  String toString() => 'PantryItem(id: ${id ?? 'null'}, name: $name, category: ${category.display}, storage: ${storageLocation.display}, expires: ${expirationDate.toIso8601String()}, lowStock: $isLowStock)';
}
